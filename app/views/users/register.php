                        ...
                        <div class="col-md-9">
                            <form action="<?php echo URLROOT; ?>/users/register" method="POST">
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="text" placeholder="Username *" name="username" id="form2Example1" class="form-control" />
                                    <label class="form-label text-light" for="form2Example1">Username</label>
                                </div>
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="email" placeholder="Email *" name="email" id="form2Example1" class="form-control" />
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="password" placeholder="Password *" name="password" id="form2Example2" class="form-control" />
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="password" placeholder="Confirm Password *" name="confirmPassword" id="form2Example2" class="form-control" />
                                    <label class="form-label text-light" for="form2Example2">Confirm Password</label>
                                </div>
                                ...
                                <div class="text-center">
                                    <button type="submit" value="submit" class="btn btn-style" style="padding: 10px 46px 12px;">Sign up</button>
                                </div>
                                <!-- Register buttons -->
